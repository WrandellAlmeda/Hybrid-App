...
<div class="section">
    ...
    <div class="row">
        ...
        <div><button class="btn btn-secondary" onClick="window.location.href=window.location.href" hidden>RELOAD</button></div>

        <form action="" method="post" onchange='if(this.value != 0) { this.form.submit(); }'>
        <center>
            <input type="submit" value="update" class="btn btn-primary btn-lg" name="btn_votes"> 
        </center>
        </form>
        <br>
    <?php 
