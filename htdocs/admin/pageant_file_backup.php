...
$time = "Pageant Report ".$current_date_pdf;
$sFilePath = __DIR__ . '/backup_files/'.$time.'.pdf';
$sFilePath_pdf= 'backup_files/'.$time.'.pdf' ;

$sql_insert_pdf=mysqli_query($conn, "INSERT INTO `dump`(`pdf_file`, `date`, `type`) VALUES ('$sFilePath_pdf','$current_date','Pageant Report')");

$pdf->Output($sFilePath,'F');
header('location: resetPageant.php?backup=Success');
