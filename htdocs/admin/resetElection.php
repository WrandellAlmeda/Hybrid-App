...
<p class="text-secondary">Please Click <b>Backup</b> before resetting Election</p>
...
<?php
        ...
        <script>
            Swal.fire(
            'Success!',
            'You can now reset the Election',
            'success'
            )
        </script>
    ...
    $sql = mysqli_query($conn, "SELECT COUNT(*) FROM votes");
    $me = $_GET['marie'];
    ...
    if($count == 0){
        ...
        <?php
            if($_GET['backup'] == 'Success'){
                ...
                ?>
                <a href="election_backup.php?backup=Success&marie=<?php echo $me;?>" class="btn btn-primary">Back Up</a>
                <?php
            }
            ...
            if($_GET['backup'] == 'Success'){
                ?>
                <a href="" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#resetelection">Reset Now</a>
                <?php
            }else{
                ?>
                <a href="" class="btn btn-secondary" style="pointer-events: none;">Reset Now</a>
