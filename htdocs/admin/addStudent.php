...
<body>
	...
	<section class="main">
		...
		<div class="card-body">
		<form action="addStudent.php" method="GET" class="form-fields center-search-form">
			<div class="d-flex flex-row justify-content-center validate">

				<div class="p-1">
					<input type="number" name="Search_LRN" minlenght="6" value="<?php if(isset($_GET['Search_LRN'])){echo $_GET['Search_LRN'];}?>" class="form-control"placeholder="LRN" required>
				</div>
			...
			if (isset($_GET['Search_LRN'])) {
				...
				elseif(mysqli_num_rows($query_run) > 0){
					...
					foreach ($query_run as $row) {
						...
						<form action="crudFunctions.php" method="Post" class="login-form">
